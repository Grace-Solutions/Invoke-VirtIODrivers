          ...
          {           
              Try
                {  
                    ...
                    $LoggingDetails.LogMessage = "$($GetCurrentDateTimeMessageFormat.Invoke()) - Web Request Response Status: $($WebRequestResponse.StatusCode) [Status Code: $($WebRequestResponse.StatusCode.value__)]" 
                    Write-Verbose -Message ($LoggingDetails.LogMessage)
                                                              ...
                                                              While ($Downloader.IsCompleted -eq $False)
                                                                {
                                                                    ...
                                                                    $LoggingDetails.LogMessage = "$($GetCurrentDateTimeMessageFormat.Invoke()) - $($EventDetails.ProgressPercentage)% - $($WriteProgressParameters.CurrentOperation)"
                                                                    Write-Verbose -Message ($LoggingDetails.LogMessage)
